...
// TODO: .app file
const appPlistName = new RegExp(/.+?\.app\/info.plist$/, 'i')
const appProvisionName = new RegExp(/.+?\.app\/embedded.mobileprovision$/, 'i')
const appName = new RegExp(/.+?\.app\/$/, 'gm') // TODO: filename = XXXX.app/
